...
uint8_t peerMac1[] = {0xC4, 0x5B, 0xBE, 0x63, 0x82, 0x5D};  // Replace with the MAC address of ESP8266-1
uint8_t peerMac2[] = {0xC8, 0xC9, 0xA3, 0x56, 0x52, 0x7C}; // Replace with the MAC address of ESP8266-2
